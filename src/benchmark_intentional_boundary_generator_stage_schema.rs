use super::{IntentionalBoundaryEvidenceCensus, IntentionalBoundaryGeneratorCensus};
use serde::{Deserialize, Serialize};

pub const INTENTIONAL_BOUNDARY_GENERATOR_STAGE_SCHEMA_VERSION: u32 = 1;

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct IntentionalBoundaryGeneratorStage {
    ...
    pub generator_census: IntentionalBoundaryGeneratorCensus,
    pub evidence_census: IntentionalBoundaryEvidenceCensus,
    pub stage_sha256: String,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum IntentionalBoundaryGeneratorStageErrorKind {
    InvalidInput,
...
pub struct IntentionalBoundaryGeneratorStageError {
    pub kind: IntentionalBoundaryGeneratorStageErrorKind,
    pub detail: String,
}
