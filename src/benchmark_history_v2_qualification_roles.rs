use super::{
    ...
    HistoricalV2SourceSnapshotCensus, IntentionalBoundarySemanticSurface,
};
...
fn classify_source_role(
    repository_path: &str,
    semantic_coverage: HistoricalV2SourceSemanticCoverage,
    ...
    if semantic_coverage == HistoricalV2SourceSemanticCoverage::VendoredPath {
        decision(
            HistoricalV2SourceRole::Vendored,
            HistoricalV2SourceRoleBasis::VendoredPath,
        )
    } else if semantic_coverage == HistoricalV2SourceSemanticCoverage::GeneratedHeader {
        decision(
            HistoricalV2SourceRole::Generated,
            HistoricalV2SourceRoleBasis::GeneratedHeader,
        )
    } else if semantic_coverage == HistoricalV2SourceSemanticCoverage::GeneratedPath {
        decision(
            HistoricalV2SourceRole::Generated,
...
mod tests {
    ...
    #[test]
    fn required_semantic_coverage_stays_production() {
        assert_eq!(
            classify_source_role(
                "src/detector.rs",
