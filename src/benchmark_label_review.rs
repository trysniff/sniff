...
pub const LABEL_REVIEW_SCHEMA_VERSION: u32 = 1;
...
fn decision_signature(decision: &MethodLabelDecision) -> (Option<FindingTier>, &str, Vec<&str>) {
    ...
    (decision.tier, decision.pattern.as_str(), related)
}
