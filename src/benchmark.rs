...
pub use release::{
    ...
    HISTORICAL_V2_SLOT_SELECTION_SCHEMA_VERSION, HISTORICAL_V2_TEST_MATERIALIZATION_SCHEMA_VERSION,
    ...
    HistoricalV2Slot, HistoricalV2SlotOutcome, HistoricalV2SlotSelection,
