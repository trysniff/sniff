...
GO_SEMANTIC_CROSS_MODULE_COVERAGE_MIGRATION_NAME = (
    "go-semantic-cross-module-coverage-v1"
)
GO_SEMANTIC_CROSS_MODULE_COVERAGE_MIGRATION_CONTRACT = (
    "sniffbench-historical-v2-go-semantic-cross-module-coverage-migration-v1"
)
GO_SEMANTIC_CROSS_MODULE_COVERAGE_MIGRATION_FROM_COLLECTOR_SHA = (
    "37a9387967cdee4d8edd904ba75118d3a87ba094"
)
GO_SEMANTIC_CROSS_MODULE_COVERAGE_MIGRATION_SOURCE_RUN_ID = 35_450_628_962
GO_SEMANTIC_CROSS_MODULE_COVERAGE_MIGRATION_SOURCE_HEAD_SHA = (
    "37a9387967cdee4d8edd904ba75118d3a87ba094"
)
GO_SEMANTIC_CROSS_MODULE_COVERAGE_MIGRATION_SOURCE_ARTIFACT_ID = 10_587_170_942
GO_SEMANTIC_CROSS_MODULE_COVERAGE_MIGRATION_SOURCE_ARTIFACT_DIGEST = (
    "sha256:d04a5ca128dbeec00e80fc825214d556f3b320bdfa6928f61fe236d768a9aca3"
)
...
DETERMINISTIC_NODE_CONSUMER_MIGRATION_NAME = "deterministic-node-consumer-profiles-v1"
DETERMINISTIC_NODE_CONSUMER_MIGRATION_CONTRACT = (
    "sniffbench-historical-v2-deterministic-node-consumer-profiles-migration-v1"
)
DETERMINISTIC_NODE_CONSUMER_MIGRATION_FROM_COLLECTOR_SHA = (
    "f6f7de50a699217f49957ee8d8a4d896077729ad"
)
DETERMINISTIC_NODE_CONSUMER_MIGRATION_SOURCE_RUN_ID = 35_482_127_947
DETERMINISTIC_NODE_CONSUMER_MIGRATION_SOURCE_HEAD_SHA = (
    "02403fd604b5176b53b626199dbe3799d21ad6f3"
)
DETERMINISTIC_NODE_CONSUMER_MIGRATION_SOURCE_ARTIFACT_ID = 10_596_700_893
DETERMINISTIC_NODE_CONSUMER_MIGRATION_SOURCE_ARTIFACT_DIGEST = (
    "sha256:f2e2ec25b4d9a324c8c1fd4f656f941c26bb8ad62e6f47b188a5d1b2b264336e"
)
...
def _migration_record(
    ...
    elif migration_name == GO_SEMANTIC_CROSS_MODULE_COVERAGE_MIGRATION_NAME:
        contract = GO_SEMANTIC_CROSS_MODULE_COVERAGE_MIGRATION_CONTRACT
        source_collector_sha = (
            GO_SEMANTIC_CROSS_MODULE_COVERAGE_MIGRATION_FROM_COLLECTOR_SHA
        )
...
def _expected_go_semantic_cross_module_coverage_migration(
    target_collector_sha: str,
) -> dict[str, Any]:
    if (
        target_collector_sha
    ...
    return _migration_record(
        GO_SEMANTIC_CROSS_MODULE_COVERAGE_MIGRATION_NAME,
        target_collector_sha,
        GO_SEMANTIC_CROSS_MODULE_COVERAGE_MIGRATION_SOURCE_RUN_ID,
        GO_SEMANTIC_CROSS_MODULE_COVERAGE_MIGRATION_SOURCE_HEAD_SHA,
        GO_SEMANTIC_CROSS_MODULE_COVERAGE_MIGRATION_SOURCE_ARTIFACT_ID,
        GO_SEMANTIC_CROSS_MODULE_COVERAGE_MIGRATION_SOURCE_ARTIFACT_DIGEST,
        GO_SEMANTIC_CROSS_MODULE_COVERAGE_MIGRATION_SOURCE_ARTIFACT_SIZE,
    )
...
def _expected_deterministic_node_consumer_migration(
    target_collector_sha: str,
) -> dict[str, Any]:
    if (
        target_collector_sha == DETERMINISTIC_NODE_CONSUMER_MIGRATION_FROM_COLLECTOR_SHA
        or re.fullmatch(r"[0-9a-f]{40}", target_collector_sha) is None
    ):
        raise ValueError("transport manifest collector migration target is invalid")
    return _migration_record(
        DETERMINISTIC_NODE_CONSUMER_MIGRATION_NAME,
        target_collector_sha,
        DETERMINISTIC_NODE_CONSUMER_MIGRATION_SOURCE_RUN_ID,
        DETERMINISTIC_NODE_CONSUMER_MIGRATION_SOURCE_HEAD_SHA,
        DETERMINISTIC_NODE_CONSUMER_MIGRATION_SOURCE_ARTIFACT_ID,
        DETERMINISTIC_NODE_CONSUMER_MIGRATION_SOURCE_ARTIFACT_DIGEST,
        DETERMINISTIC_NODE_CONSUMER_MIGRATION_SOURCE_ARTIFACT_SIZE,
    )
...
def _validate_collector_migrations(
    ...
    if len(migrations) == 2:
        ...
        if len(migrations) >= 38:
            expected.append(
                _expected_go_semantic_effective_test_coverage_migration(
                    GO_SEMANTIC_CROSS_MODULE_COVERAGE_MIGRATION_FROM_COLLECTOR_SHA
        ...
        if len(migrations) >= 41:
            expected.append(
                _expected_assessment_source_replay_migration(
                    DETERMINISTIC_NODE_CONSUMER_MIGRATION_FROM_COLLECTOR_SHA
